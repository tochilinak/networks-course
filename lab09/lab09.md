...
![image](https://github.com/tochilinak/networks-course/assets/35286460/44f2d9cd-b224-48f1-abd0-0780b7998771)
...
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   - Потому что взаимодействие происходит между хостами, а не между процессами (на хосте только один актор --- он сам).
...
4. Рассмотрите соответствующий ping-пакет, полученный в ответ на предыдущий. 
   ...
   - Тип: 0, код: 0
   - Поля те же: Checksum, Identifier, Sequence number, Timestamp
   - Тоже по 2 байта

![image](https://github.com/tochilinak/networks-course/assets/35286460/2b1d2150-042b-4810-bbb3-1c6feeb6d9ed)
...
1. Рассмотрите ICMP-пакет с эхо-запросом на вашем скриншоте. Отличается ли он от ICMP-пакетов
   ...
   - Тут пакеты отличаются пометкой, что ответ не был получен. Также поменьше размер данных.

![image](https://github.com/tochilinak/networks-course/assets/35286460/7b6ad5a6-e329-412d-9663-efcf1faa98e9)
...
2. Рассмотрите на вашем скриншоте ICMP-пакет с сообщением об ошибке. В нем больше полей,
   ...
   - Он содержит в себе пакет, который не удалось отправить.

![image](https://github.com/tochilinak/networks-course/assets/35286460/1e49a208-99be-49b5-aad5-e43a1aae573e)
...
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   ...
   - Три последних пакета отличаются тем, что на них есть ответы.
   - Мы дошли до конечной точки.

![image](https://github.com/tochilinak/networks-course/assets/35286460/1c81a1b9-dc36-4cec-810b-1886d13ccb2d)
...
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ...
   - Да, между `bro-cr02-ae4.150.stk.mts-internet.net` и `stanford-university.e0-62.core2.pao1.he.net`
   - Первый маршрутизатор принадлежит МТС (я сейчас пользуюсь мобильным интернетом), второй Стэнфорду.

![image](https://github.com/tochilinak/networks-course/assets/35286460/f58ceb6d-1ffc-478d-9eae-1faf222ed83b)
